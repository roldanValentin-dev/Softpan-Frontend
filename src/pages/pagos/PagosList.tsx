    ...
    <AppLayout>
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 mb-1">Pagos</h1>
            <p className="text-gray-600">Historial de pagos registrados</p>
          </div>
                ...
                <div key={pago.id} className="card hover:shadow-xl transition-shadow">
                  <div className="flex justify-between items-start mb-3">
                    <div>
                      ...
                      <h3 className="font-bold text-gray-900 text-xl">#{pago.id}</h3>
                    </div>
                  ...
                  <div className="space-y-2 mb-4">
                    <div>
                      ...
                      <p className="font-semibold text-gray-900">{pago.clienteNombre}</p>
                    </div>
                    <div>
                      <span className="text-sm text-gray-600">Fecha</span>
                      <p className="text-sm text-gray-900">{formatDateTime(pago.fechaPago)}</p>
                    </div>
                    {pago.observaciones && (
                      <div>
                        <span className="text-sm text-gray-600">Observaciones</span>
                        <p className="text-sm text-gray-900">{pago.observaciones}</p>
                      </div>
                    )}
                  </div>
              ...
              <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-gradient-to-r from-gray-50 to-gray-100">
                  <tr>
                    ...
                    <th className="hidden xl:table-cell px-6 py-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">
                      Observaciones
                    </th>
